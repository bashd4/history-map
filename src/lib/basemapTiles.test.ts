...
import {
  pickHillshadeZoom, DARK, LIGHT, overlayDestRect, TILE_SIZE,
...
describe('overlayDestRect', () => {
  it('a terrain tile one zoom coarser covers a 2× region of the hillshade canvas', () => {
    ...
    const r = overlayDestRect(4000, 3000, zLo, cov)
  ...
  it('offsets by whole hillshade tiles for neighbouring terrain tiles', () => {
    ...
    const r = overlayDestRect(4001, 3000, 13, cov) // one tile east at zLo
